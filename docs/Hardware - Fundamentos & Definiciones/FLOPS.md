...
![](../Imagenes/Pasted%20image%2020260210171240.png)
...
- **Paralelismo**: Si nuestro procesador cuenta con varios núcleos puede ejecutar mas operaciones en simultaneo; por esto las GPUs tienen mejor [Benchmark](Benchmark.md) que otras unidades de proceso no dedicadas a esto como las CPUs.
...
La métrica FLOPs nos permite saber de manera independiente al hardware la [Latencia de Inferencia](Latencia%20de%20Inferencia.md) del modelo. De esta forma, podemos escoger sabiamente el [LLM](../LLM%20-%20Conceptos%20&%20Modelos/LLM.md) o red neuronal que mas nos convenga. Ya sea para hacer computacion en la nube, o en nuestro caso [Edge AI](../Machine%20Learning%20-%20Fundamentos%20&%20Definiciones/Edge%20AI.md), el cual requiere FLOPs mas pequeños porque la métrica FLOPS de nuestras placas son menores. 